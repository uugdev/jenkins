		...
		<div class="tablearea">
			...
			<tbody>
				...
				<tr>
					...
					<fmt:formatDate value="${ask.ASK_COM_DATE }" pattern="yyyyMMdd" var="timeStr" />
					<fmt:formatDate value="<%=new Date()%>" pattern="yyyyMMdd" var="nowStr" />
					<td>
						<c:choose>
							<c:when test="${timeStr lt nowStr }">
								<fmt:formatDate value="${ask.ASK_COM_DATE }" pattern="yy-MM-dd" />
							</c:when>
							<c:when test="${timeStr eq nowStr }">
								<fmt:formatDate value="${ask.ASK_COM_DATE }" pattern="HH:mm" />
							</c:when>
						</c:choose>
					</td>
				</tr>
