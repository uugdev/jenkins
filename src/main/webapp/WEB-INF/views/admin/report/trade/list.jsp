	...
	$.ajax({
		...
		, success: function(data){
			if(data.changeStatus) {
				...
				$(".btnStatusN"+tradeNo).before('<button id="statusY" class="btnStatusY'+ tradeNo +'" onclick="statusToN('+ tradeNo +');">완료</button>');
	...
	$.ajax({
		...
		, success: function(data){
			if(data.changeStatus) {
				...
				$(".btnStatusY"+tradeNo).before('<button id="statusN" class="btnStatusN'+ tradeNo +'" onclick="statusToY('+ tradeNo +');" >미완료</button>');
...
<tr>
	...
	<c:if test="${trade.REPORT_STATUS == 'n' }">
		<td><button class="btnStatusN${trade.TRADE_NO }" id="statusN" onclick="statusToY(${trade.TRADE_NO});" >미완료</button></td>
	</c:if>
	<c:if test="${trade.REPORT_STATUS == 'y' }">
		<td><button class="btnStatusY${trade.TRADE_NO }" id="statusY" onclick="statusToN(${trade.TRADE_NO});">완료</button></td>
	</c:if>
