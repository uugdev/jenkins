...
<form action="/admin/qna/com/update" method="post">
<input type="hidden" name="qnaNo" value="${qnaComment.qnaNo }" />
<input type="hidden" name="qnaComNo" value="${qnaComment.qnaComNo }" />
