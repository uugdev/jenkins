...
<tr>
	...
	<td><input type="number" id="extraMoney" name="extraMoney" placeholder="여유자금을 입력하세요" autocomplete="off" required min="0" maxlength="9" oninput="viewKorean(); checkMaxLength(this);"/>
	<span class="pull-right" id="won"></span></td>
</tr>
<tr>
