		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar"
				...
				<ul class="nav navbar-nav" id="navbar">
					<li class="dropdown">
						<a class="dropdown-toggle" data-target="#" data-toggle="dropdown" role="button" aria-expanded="false" style="margin: 7px 0 0 30px;">
					...
					<li><a href="/account/main" style="margin: 7px 0 0 30px;"><h3 style="font-weight: bold;">가계부</h3></a></li>
					<li><a href="/mypage/info" style="margin: 7px 0 0 30px;"><h3 style="font-weight: bold;">마이페이지</h3></a></li>
					<li><a href="/qna/list" style="margin: 7px 0 0 30px;"><h3 style="font-weight: bold;">문의</h3></a></li>
				</ul>
